...
function Get-Zimmer {
  ...
  Start-Process -FilePath pwsh.exe -ArgumentList "-NoProfile -NoNewWindow -ExecutionPolicy Bypass -File `"$XWAYSUSB\Triage\KAPE\KAPE-EZToolsAncillaryUpdater.ps1`" -netVersion 6  -silent" -Wait -Verb RunAs
