function Update-USBTools {
  ...
  Start-Process -FilePath pwsh.exe -ArgumentList '-noexit -command "chocolatey upgrade chocolatey.extension;chocolatey upgrade all"'
  ...
  Start-Process -FilePath pwsh.exe -ArgumentList '-noexit -command "winget source update --disable-interactivity --force"'
